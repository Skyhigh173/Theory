...
var id = "polynomials_M"
var name = "Polynomials Mod";
var description = "An implementation of the 'Polynomials' theory from the game. Pls notice that this is spoiler!";
...
var init = () => {
    ...
    // c3
    {
        ...
        c3 = theory.createUpgrade(2, currency, new FreeCost());
    ...
    // c4
    {
        ...
        c4 = theory.createUpgrade(3, currency, new FreeCost());
    ...
    // c5
    {
        ...
        c5 = theory.createUpgrade(4, currency, new FreeCost());
    ...
    // c6
    {
        ...
        c6 = theory.createUpgrade(5, currency, new FreeCost());
    ...
    // q1
    {
        ...
        q1 = theory.createUpgrade(6, currency, new FreeCost());
    ...
    // q2
    {
        ...
        q2 = theory.createUpgrade(7, currency, new FreeCost());
...
var getPublicationMultiplier = (tau) => tau.pow(0.7) / BigNumber.FOUR;
var getPublicationMultiplierFormula = (symbol) => "\\frac{{" + symbol + "}^{0.7}}{4}";
