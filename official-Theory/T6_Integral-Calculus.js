...
var id = "integral_calculus_M"
var name = "Integral Calculus Mod";
var description = "An implementation of the 'Integral Calculus' theory from the game. Pls notice that this is spoiler!";
...
var init = () => {
    ...
    // r1
    {
        ...
        r1 = theory.createUpgrade(2, currency, new FreeCost());
    ...
    // r2
    {
        ...
        r2 = theory.createUpgrade(3, currency, new FreeCost());
    ...
    // c1
    {
        ...
        c1 = theory.createUpgrade(4, currency, new FreeCost());
    ...
    // c2
    {
        ...
        c2 = theory.createUpgrade(5, currency, new FreeCost());
    ...
    // c3
    {
        ...
        c3 = theory.createUpgrade(6, currency, new FreeCost());
    ...
    // c4
    {
        ...
        c4 = theory.createUpgrade(7, currency, new FreeCost());
    ...
    // c5
    {
        ...
        c5 = theory.createUpgrade(8, currency, new FreeCost());
...
var getPublicationMultiplier = (tau) => tau.pow(0.7) / 50;
var getPublicationMultiplierFormula = (symbol) => "\\frac{{" + symbol + "}^{0.7}}{50}";
