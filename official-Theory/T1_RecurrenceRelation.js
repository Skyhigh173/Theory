...
var id = "recurrence_relation_M";
var name = "Recurrence Relation Mod";
var description = "An implementation of the 'Recurrence Relation' theory from the game. Pls notice that this is a spoiler! ";
...
var getPublicationMultiplier = (tau) => tau.pow(10000) / BigNumber.THREE;
var getPublicationMultiplierFormula = (symbol) => "\\frac{{" + symbol + "}^{1000}}{3}";
