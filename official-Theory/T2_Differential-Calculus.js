...
var id = "differential_calculus_M"
var name = "Differential Calculus Mod";
var description = "An implementation of the 'Differential Calculus' theory from the game. Pls notice that this is the spoiler!";
...
var init = () => {
    ...
    // q1
    {
        ...
        dq1 = theory.createUpgrade(0, currency, new FreeCost());
    ...
    // q2
    {
        ...
        dq2 = theory.createUpgrade(1, currency, new FreeCost());
    ...
    // q3
    {
        ...
        dq3 = theory.createUpgrade(2, currency, new FreeCost());
    ...
    // q4
    {
        ...
        dq4 = theory.createUpgrade(3, currency, new FreeCost());
    ...
    // r1
    {
        ...
        dr1 = theory.createUpgrade(4, currency, new FreeCost());
    ...
    // r2
    {
        ...
        dr2 = theory.createUpgrade(5, currency, new FreeCost());
    ...
    // r3
    {
        ...
        dr3 = theory.createUpgrade(6, currency, new FreeCost());
    ...
    // r4
    {
        ...
        dr4 = theory.createUpgrade(7, currency, new FreeCost());
...
var getPublicationMultiplier = (tau) => tau.pow(0.7) / BigNumber.HUNDRED;
var getPublicationMultiplierFormula = (symbol) => "\\frac{{" + symbol + "}^{0.7}}{100}";
