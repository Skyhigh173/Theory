...
var init = () => {
    ...
    // b1
    {
        ...
        b1 = theory.createUpgrade(0, currency1, new FreeCost());
    ...
    // b2
    {
        ...
        b2 = theory.createUpgrade(1, currency2, new FreeCost());
    ...
    // b3
    {
        ...
        b3 = theory.createUpgrade(2, currency3, new FreeCost());
    ...
    // c11
    {
        ...
        c11 = theory.createUpgrade(3, currency1, new FreeCost());
    ...
    // c12
    {
        ...
        c12 = theory.createUpgrade(4, currency2, new FreeCost());
    ...
    // c13
    {
        ...
        c13 = theory.createUpgrade(5, currency3, new FreeCost());
    ...
    // c21
    {
        ...
        c21 = theory.createUpgrade(6, currency1, new FreeCost());
    ...
    // c22
    {
        ...
        c22 = theory.createUpgrade(7, currency2, new FreeCost());
    ...
    // c23
    {
        ...
        c23 = theory.createUpgrade(8, currency3, new FreeCost());
    ...
    // c31
    {
        ...
        c31 = theory.createUpgrade(9, currency1, new FreeCost());
    ...
    // c32
    {
        ...
        c32 = theory.createUpgrade(10, currency2, new FreeCost());
    ...
    // c33
    {
        ...
        c33 = theory.createUpgrade(11, currency3, new FreeCost());
    ...
    /////////////////////
    // Permanent Upgrades
    theory.createPublicationUpgrade(0, currency1, 1e1);
    theory.createBuyAllUpgrade(1, currency1, 1e1);
    theory.createAutoBuyerUpgrade(2, currency1, 1e1);
...
var getPublicationMultiplierFormula = (symbol) => "3{" + symbol + "}^{0.7}";
