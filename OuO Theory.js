...
var init = () => {
    ...
    // n
    {
        let getDesc = (level) => "n=" + getC1(level).toString(0);
        n = theory.createUpgrade(0, currency, new FirstFreeCost(new ExponentialCost(0, Math.log2(0))));
