...
var getTau = () => currency.value.pow(BigNumber.HUNDRED).pow(BigNumber.HUNDRED).pow(BigNumber.HUNDRED).pow(BigNumber.HUNDRED).pow(BigNumber.THOUSAND).pow(BigNumber.THOUSAND).pow(BigNumber.THOUSAND).pow(BigNumber.THOUSAND).pow(BigNumber.THOUSAND).pow(BigNumber.THOUSAND).pow(BigNumber.THOUSAND).pow(BigNumber.THOUSAND).pow(BigNumber.THOUSAND);
